...
import MessageModal from './MessageModal.vue';
    export default {
        props: ['id', 'name', 'price', 'description', 'image', 'isFavorite'],
        components: {
            MessageModal
        },
        setup(props, {emit}) {
            ...
            return {quantityValue, noticeChangeInQuantityInput, showErrorMessage, isFavoriteProduct, toggleFavorite, isShowingMessageModal, closeModal}
        }
    }
</script>
...
<template>
    ...
    <div class="drink-card">
        ...
        <div class="drink-interaction">
            <div>
                <label style="margin-right: 0.5vw;" for="quantity-input">Quantity: </label>
